...
hr_files=list.files(path = "output/review/model/vax/", pattern = "to_release")
hr_files=hr_files[endsWith(hr_files,".csv")]
hr_files=paste0("output/review/model/vax/", hr_files)
...
hr_files=list.files(path = "output/review/model/unvax/", pattern = "to_release")
hr_files=hr_files[endsWith(hr_files,".csv")]
hr_files=paste0("output/review/model/unvax/", hr_files)
