...
get_vacc_res <- function(event,subgroup,stratify_by_subgroup,stratify_by,time_point,data_only,input,covar_names,cuts_days_since_expo,cuts_days_since_expo_reduced,cuts_days_since_expo_day_zero,cuts_days_since_expo_reduced_day_zero,mdl){
  ...
  if(time_point == "reduced"){
    res_vacc <- fit_model_reducedcovariates(event,subgroup,stratify_by_subgroup,stratify_by,mdl, survival_data,input,cuts_days_since_expo=cuts_days_since_expo_reduced,covar_names,time_point,total_covid_cases,data_only)
  }else if(time_point == "normal"){
    res_vacc <- fit_model_reducedcovariates(event,subgroup,stratify_by_subgroup,stratify_by,mdl, survival_data,input,cuts_days_since_expo,covar_names,time_point,total_covid_cases,data_only)
  }else if(time_point == "day_zero_reduced"){
    res_vacc <- fit_model_reducedcovariates(event,subgroup,stratify_by_subgroup,stratify_by,mdl, survival_data,input,cuts_days_since_expo=cuts_days_since_expo_reduced_day_zero,covar_names,time_point,total_covid_cases,data_only)
  }else if(time_point == "day_zero_normal"){
    res_vacc <- fit_model_reducedcovariates(event,subgroup,stratify_by_subgroup,stratify_by,mdl, survival_data,input,cuts_days_since_expo=cuts_days_since_expo_day_zero,covar_names,time_point,total_covid_cases,data_only)
  }
