...
main_estimates$colour <- ifelse(main_estimates$analysis=="Type 2 diabetes - COVID censored 16th June","#009999",main_estimates$colour) # Black
...
main_estimates$analysis <- factor(main_estimates$analysis, levels=c("Type 2 diabetes - main analysis","Type 2 diabetes - COVID censored 16th June")) 
...
png(paste0(output_dir,"Figure_t2dm_recovery_3panel.png"),
