...
actions_list <- splice(
  ...
  action(
    ...
    needs = list("generate_study_population_prelim", "generate_study_population_prevax", "generate_study_population_vaccinated", "generate_study_population_unvaccinated"),
    moderately_sensitive = list(
