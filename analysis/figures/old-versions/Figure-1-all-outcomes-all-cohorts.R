...
# exclude subgroups
remove <- c("t2dm_pd", "t2dm_pd_no", "t2dm_obes", "t2dm_obes_no")
...
main_estimates$outcome <- factor(main_estimates$outcome, levels=c("Type 1 Diabetes",
                                                                  "Type 2 Diabetes",
...
for(i in c("any_position")){
  ...
  ggplot2::ggsave(paste0(output_dir,"Figure1_all_cohorts",i,".png"), height = 297, width = 220, unit = "mm", dpi = 600, scale = 1)
